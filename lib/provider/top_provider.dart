...
class Top_Provider extends ChangeNotifier{
  ...
  List <videocall>l1 = [
    ...
    videocall(con: "Armenia",km: "1.4km",year: "22",TImage: "assets/image/Image-7.jpg",Image2: "assets/image/28.jpg",flag:     "🇦🇮",Image: "assets/image/8.jpg",centry:  "25,Armenia",like:"28.3",          Name: "Khristin" ,video: "assets/video/8.mp4"),
    ...
    videocall(con: "Cambodia",km: "7.5km",year: "29",TImage: "assets/image/p20.jpg",Image2: "assets/image/1.jpg",flag:    "🇻🇬",Image: "assets/image/31.jpg",centry: "30,Sri Lanka",like:"45.1"        ,Name: "Ol'ga ",video: "assets/video/1.mp4"),
    videocall(con: "Cameroon",km: "8.4km",year: "21",TImage: "assets/image/p21.jpg",Image2: "assets/image/2.jpg",flag:    "🇧🇳",Image: "assets/image/32.jpg",centry: "17,Sudan",like:"99",              Name: "Olechka ",video: "assets/video/2.mp4"),
    videocall(con: "Canada",km: "6.4km",year: "23",TImage: "assets/image/p22.jpg",Image2: "assets/image/3.jpg",flag:      "🇧🇬",Image: "assets/image/33.jpg",centry: "19,Suriname",like:"45.1",         Name: "Olien ",video: "assets/video/3.mp4"),
    videocall(con: "Niger",km: "4.1km",year: "22",TImage: "assets/image/p23.jpg",Image2: "assets/image/4.jpg",flag:       "🇧🇫",Image: "assets/image/34.jpg",centry: "21,Sweden",like:"12",             Name: "Olya ",video: "assets/video/4.mp4"),
    videocall(con: "Chad",km: "1.5km",year: "24",TImage: "assets/image/p24.jpg",Image2: "assets/image/5.jpg",flag:        "🇧🇮",Image: "assets/image/35.jpg",centry: "23,Switzerland",like:"1.1",       Name: "Paraaha ",video: "assets/video/5.mp4"),
    videocall(con: "Chile	",km: "6.1km",year: "18",TImage: "assets/image/p25.jpg",Image2: "assets/image/6.jpg",flag:      "🇰🇭",Image: "assets/image/36.jpg",centry: "25,Syria",like:"6.4",             Name: "Pheodora ",video: "assets/video/6.mp4"),
    videocall(con: "China	",km: "9.4km",year: "21",TImage: "assets/image/p26.jpg",Image2: "assets/image/7.jpg",flag:      "🇨🇲",Image: "assets/image/37.jpg",centry: "27,Iceland",like:"8.4",           Name: "Polina ",video: "assets/video/7.mp4"),
    videocall(con: "Colombia",km: "6.1km",year: "22",TImage: "assets/image/p27.jpg",Image2: "assets/image/8.jpg",flag:    "🇨🇦",Image: "assets/image/38.jpg",centry: "29,India",like:"14.2",            Name: "Rada ",video: "assets/video/8.mp4"),
    videocall(con: "Comoros",km: "7.2km",year: "23",TImage: "assets/image/p28.jpg",Image2: "assets/image/9.jpg",flag:     "🇮🇨",Image: "assets/image/39.jpg",centry: "22Indonesia",like:"46.2",         Name: "Radinka ",video: "assets/video/9.mp4"),
    videocall(con: "Congo ",km: "9.4km",year: "24",TImage: "assets/image/p29.jpg",Image2: "assets/image/10.jpg",flag:     "🇨🇻",Image: "assets/image/40.jpg",centry: "29,Iran",like:"94.2",             Name: "Renata ",video: "assets/video/10.mp4"),
    videocall(con: "Costa Rica",km: "6.1km",year: "25",TImage: "assets/image/p10.jpg",Image2: "assets/image/11.jpg",flag: "🇧🇶",Image: "assets/image/41.jpg",centry: "21,Iraq",like:"45.1",             Name: "Roksana",video: "assets/video/11.mp4"),
    videocall(con: "Croatia",km: "7.4km",year: "21",TImage: "assets/image/p11.jpg",Image2: "assets/image/12.jpg",flag:    "🇰🇾",Image: "assets/image/42.jpg",centry: "23,Ireland",like:"64.2",           Name: "Roza ",video: "assets/video/12.mp4"),
    videocall(con: "Cuba	",km: "6.4km",year: "23",TImage: "assets/image/p12.jpg",Image2: "assets/image/13.jpg",flag:     "🇨🇫",Image: "assets/image/43.jpg",centry: "22,Israel",like:"94.2",            Name: "Svetlana ",video: "assets/video/13.mp4"),
    videocall(con: "Cyprus",km: "6.0km",year: "24",TImage: "assets/image/p13.jpg",Image2: "assets/image/14.jpg",flag:     "🇹🇩",Image: "assets/image/44.jpg",centry: "24,Italy",like:"94.5",             Name: "Tavisha ",video: "assets/video/14.mp4"),
    videocall(con: "Czechia ",km: "4.2km",year: "19",TImage: "assets/image/p14.jpg",Image2: "assets/image/15.jpg",flag:   "🇮🇴",Image: "assets/image/45.jpg",centry: "18,Jamaica",like:"87.5",           Name: "Vanka ",video: "assets/video/15.mp4"),
    videocall(con: "Democratic ",km: "3.1km",year: "18",TImage: "assets/image/p15.jpg",Image2: "assets/image/16.jpg",flag:"🇨🇱",Image: "assets/image/46.jpg",centry: "21,Japan",like:"94.5",             Name: "Zhanna ",video: "assets/video/16.mp4"),
    videocall(con: "Denmark	",km: "3.9km",year: "24",TImage: "assets/image/p16.jpg",Image2: "assets/image/17.jpg",flag:   "🇨🇳",Image: "assets/image/47.jpg",centry: "22,Jordan",like:"1",               Name: "Nika ",video: "assets/video/17.mp4"),
    videocall(con: "Djibouti",km: "3.2km",year: "18",TImage: "assets/image/p17.jpg",Image2: "assets/image/18.jpg",flag:   "🇨🇽",Image: "assets/image/48.jpg",centry: "23,Laos",like:"54",                Name: "Nikita ",video: "assets/video/18.mp4"),
    videocall(con: "Iran",km: "4.2km",year: "25",TImage: "assets/image/p18.jpg",Image2: "assets/image/19.jpg",flag:       "🇨🇴",Image: "assets/image/49.jpg",centry: "24,Latvia",like:"45.5",            Name: "Raisa ",video: "assets/video/19.mp4"),
    videocall(con: "India",km: "8.4km",year: "19",TImage: "assets/image/p19.jpg",Image2: "assets/image/20.jpg",flag:      "🇫🇮",Image: "assets/image/50.jpg",centry: "25,Lebanon",like:"34.1",            Name: "Regina ",video: "assets/video/20.mp4"),
  ];
  ...
  List <Superhero> marvelHeroes = [
    Superhero(heroName: 'Vivian',      name: ' 🇦🇫 Afghanistan', pathImage: 'assets/image/1r.png',),
    Superhero(heroName: 'Clara',       name: ' 🇦🇽 Albania', pathImage: 'assets/image/2r.png',),
    Superhero(heroName: 'Raelynn',     name: ' 🇦🇱 Algeria', pathImage: 'assets/image/3r.png',),
    Superhero(heroName: 'Liliana',     name: ' 🇩🇿 Ando', pathImage: 'assets/image/4r.png',),
    Superhero(heroName: 'Samantha',    name: ' 🇦🇸 Angola', pathImage: 'assets/image/5r.png',),
    Superhero(heroName: 'Maria',       name: ' 🇦🇩 Italy', pathImage: 'assets/image/6r.png',),
    Superhero(heroName: 'Iris',        name: ' 🇦🇴 Argentina', pathImage: 'assets/image/7r.png',),
    Superhero(heroName: 'Ayla',        name: ' 🇦🇮 Armenia",km: ', pathImage: 'assets/image/8r.png',),
    Superhero(heroName: 'Eloise',      name: ' 🇦🇶 Australia', pathImage: 'assets/image/9r.png',),
    Superhero(heroName: 'Lyla',        name: ' 🇦🇬 Austria', pathImage: 'assets/image/10r.png',),
    Superhero(heroName: 'Eliza',       name: ' 🇦🇷 Azerbaijan', pathImage: 'assets/image/11r.png',),
    Superhero(heroName: 'Hadley',      name: ' 🇦🇲 Bahamas', pathImage: 'assets/image/12r.png',),
    Superhero(heroName: 'Melody',      name: ' 🇦🇼 Bahrain', pathImage: 'assets/image/13r.png',),
    Superhero(heroName: 'Julia',       name: ' 🇦🇺 Bangladesh', pathImage: 'assets/image/14r.png',),
    Superhero(heroName: 'Parker',      name: ' 🇦🇹 Barbad', pathImage: 'assets/image/15r.png',),
    Superhero(heroName: 'Rose',        name: ' 🇦🇿 Belarus', pathImage: 'assets/image/16.png',),
    Superhero(heroName: 'Isabelle',    name: ' 🇧🇸 Belgium', pathImage: 'assets/image/17r.png',),
    Superhero(heroName: 'Brielle',     name: ' 🇧🇭 Belize"', pathImage: 'assets/image/18r.png',),
    Superhero(heroName: 'Adalynn',     name: ' 🇧🇩 Benin', pathImage: 'assets/image/19.jpg',),
    Superhero(heroName: 'Arya',        name: ' 🇧🇧 Bhutan', pathImage: 'assets/image/20r.png',),
    Superhero(heroName: 'Eden',        name: ' 🇧🇾 Bolivia', pathImage: 'assets/image/21r.png',),
    Superhero(heroName: 'Remi',        name: ' 🇧🇪 Latvia', pathImage: 'assets/image/22r.png',),
    Superhero(heroName: 'Mackenzie',   name: ' 🇧🇿 Botswana', pathImage: 'assets/image/23r.png',),
    Superhero(heroName: 'Maeve',       name: ' 🇧🇯 Brazil', pathImage: 'assets/image/24r.png',),
    Superhero(heroName: 'Margaret',    name: ' 🇧🇲 Brune', pathImage: 'assets/image/25r.png',),
    Superhero(heroName: 'Reagan',      name: ' 🇧🇹 Bulgaria', pathImage: 'assets/image/26r.png',),
    Superhero(heroName: 'Charlie',     name: ' 🇧🇴 Laos', pathImage: 'assets/image/27r.png',),
    Superhero(heroName: 'Alaia',       name: ' 🇧🇦 Burundi', pathImage: 'assets/image/28r.png',),
    Superhero(heroName: 'Melanie',     name: ' 🇧🇼 Israel', pathImage: 'assets/image/29r.png',),
    Superhero(heroName: 'Josie',       name: ' 🇧🇷 Cabo Verde', pathImage: 'assets/image/30r.png',),
    Superhero(heroName: 'Elliana',     name: ' 🇻🇬 Cambodia', pathImage: 'assets/image/31r.png',),
    Superhero(heroName: 'Cecilia',     name: ' 🇧🇳 Cameroon', pathImage: 'assets/image/32r.png',),
    Superhero(heroName: 'Mary',        name: ' 🇧🇬 Canada', pathImage: 'assets/image/33r.png',),
    Superhero(heroName: 'Daisy',       name: ' 🇧🇫 Niger', pathImage: 'assets/image/34r.png',),
    Superhero(heroName: 'Alina',       name: ' 🇧🇮 Chad', pathImage: 'assets/image/35r.png',),
    Superhero(heroName: 'Lucia',       name: ' 🇰🇭 Chile', pathImage: 'assets/image/36r.png',),
    Superhero(heroName: 'Ximena',      name: ' 🇨🇲 China', pathImage: 'assets/image/37r.png',),
    Superhero(heroName: 'Juniper',     name: ' 🇨🇦 Colombia', pathImage: 'assets/image/38.jpg',),
    Superhero(heroName: 'Kaylee',      name: ' 🇮🇨 Comoros', pathImage: 'assets/image/39r.png',),
    Superhero(heroName: 'Magnolia',    name: ' 🇨🇻 Congo', pathImage: 'assets/image/40r.png',),
    Superhero(heroName: 'Summer',      name: ' 🇧🇶 Costa Rica', pathImage: 'assets/image/41r.png',),
    Superhero(heroName: 'Adalyn',      name: ' 🇰🇾 Croatia', pathImage: 'assets/image/42r.png',),
    Superhero(heroName: 'Sloane',      name: ' 🇨🇫 Cuba', pathImage: 'assets/image/43r.png',),
    Superhero(heroName: 'Amara',       name: ' 🇹🇩 Cyprus', pathImage: 'assets/image/44r.png',),
    Superhero(heroName: 'Arianna',     name: ' 🇮🇴 Czechia', pathImage: 'assets/image/45r.png',),
    Superhero(heroName: 'Isabel',      name: ' 🇨🇱 Democratic', pathImage: 'assets/image/46r.png',),
    Superhero(heroName: 'Reese',       name: ' 🇨🇳 Denmark', pathImage: 'assets/image/47r.png',),
    Superhero(heroName: 'Emersyn',     name: ' 🇨🇽 Djibouti', pathImage: 'assets/image/48r.png',),
    Superhero(heroName: 'Sienna',      name: ' 🇨🇴 Iran', pathImage: 'assets/image/49r.png',),
    Superhero(heroName: 'Kehlani',     name: ' 🇫🇮 India', pathImage: 'assets/image/50r.png',),
